...
# Main Execution Loop
# ================================================================
def run_single_seed_iid(seed: int, X_all, y_all, p_all):
    print(f"\n================ IID SEED {seed} ================\n")
    np.random.seed(seed)
    ...
    input_dim = X_tr.shape[1]
    print(f"COMPAS Cox (IID, seed={seed}): {len(X_tr)} train, {len(X_val)} val, {len(X_te)} test | dim={input_dim}")
...
def main():
    ...
    for s in SEEDS:
        res_s = run_single_seed_iid(s, X_all, y_all, p_all)
    ...
    print("\n===================================================")
    print("MEAN±STD OVER 30 SEEDS (COMPAS Cox, IID)")
    print("===================================================\n")
