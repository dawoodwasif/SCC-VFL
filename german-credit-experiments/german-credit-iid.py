...
def load_german_credit_data():
    """Fetches and returns the German Credit dataset."""
...
def run_single_seed(seed: int, X_raw: pd.DataFrame, Y_raw: pd.DataFrame):
    ...
    acc, ll, enc_u, clf_u, gen_u = train_uniform_cf(X_tr, y_tr, X_te, y_te, epochs=120, lr=0.01, lam_cons=0.2)
...
def main():
    ...
    print("\n===================================================")
    print("MEAN±STD OVER 30 SEEDS (German Credit, IID)")
    print("===================================================\n")
